...
Por ejemplo, la tabla se presentan las siguientes dependencias
funcionales:
...
> Toda la sección ha sido extraída de Pedro Pablo Alarcón (2012),
...
- Produce una nueva relación que están en la relación $R$, pero no están
  en $S$
