---
marp        : true
title       : Presentación de la asignatura Bases de Datos. Curso 2025-2026.
paginate    : true
theme       : bbdd
...
Las clases se desarrollarán en el aula 3202 en el siguiente horario:
...
Prueba escrita el **Viernes 10 de julio de 2025 a las 15:00** (Aula 4303) incluyendo preguntas teórico-prácticas de todo el temario de la asignatura
...
1. **Moodle de la asignatura.**. Todo el material se genera desde: [https://github.com/bbddetsisi/material-docente](https://github.com/bbddetsisi/material-docente). Se aceptan *Pull Requeste*.
