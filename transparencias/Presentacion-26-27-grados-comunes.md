---
marp        : true
title       : Presentación de la asignatura Bases de Datos. Curso 2026-2027.
paginate    : true
theme       : bbdd
header      : Presentación de la asignatura Bases de Datos. Curso 2026-2027.
description : >
  Presentación de la asignatura Bases de Datos. Curso 2026-2027.
...
## Bases de datos - Curso 2026-2027
...
- Guillermo Iglesias. guillermo.iglesias@upm.es. *Despacho 1119*.
- Raul Lara (**Coordinador**). raul.lara@upm.es. *Despacho 1227*.
- María Ángeles Mahillo. mariaangeles.mahillo@upm.es. *Despacho 1112*.
- Fernando Ortega. fernando.ortega@upm.es. *Despacho 1110*.
...
- Nota mínima de 5
- Examen escrito sobre la práctica desarrollada durante el curso

Ambos exámenes se realizarán el **jueves 14 de enero de 2027 a las 15:00**.

Será necesario alcanzar una nota total mayor o igual 5 para aprobar la asignatura. Si se aprueba uno de los exámenes, se guarda la nota para la convocatoria extraordinaria.
...
Prueba escrita el **martes 29 de junio de 2027 a las 09:00** incluyendo el examen de teoría y el de prácticas en las mismas condiciones que en la convocatoria ordinaria.
